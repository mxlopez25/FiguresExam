...
export default function FigureScreen() {
  ...
  React.useEffect(() => {
    if (
      ...
      const r1 = Math.sqrt(
        Math.pow(sideA - sideC + sideE, 2) + Math.pow(sideB + sideD + sideF, 2)
      );
    ...
    <ScrollView style={styles.figuresContainer}>
      ...
      <View>
        <View style={styles.figuresTopOptions}>
          ...
          <Pressable
            ...
            onPress={() => {
              figures.setFiguresData(1, !figures.figure1);
            }}
          >
        ...
        <TextInput
          style={styles.input}
          value={figures.figure1a.toString()}
          editable={false}
        />
      ...
      <View style={{ flex: 1 }}>
        <View style={styles.figuresTopOptions}>
          ...
          <Pressable
            onPress={() => {
              figures.setFiguresData(2, !figures.figure2);
            }}
            style={{ borderColor: "#FFFFFF", borderRadius: 4 }}
          >
            <Text style={styles.boldStyle}>Pick Figure</Text>
          </Pressable>
        </View>
        ...
        <TextInput
          style={styles.input}
          value={figures.figure2g.toString()}
          editable={false}
        />
      </View>
      {/* End Figure 2 */}
